...
import (
	...
	"github.com/zero-element/go-etdereum/crypto/signify"
	"github.com/zero-element/go-etdereum/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/zero-element/go-etdereum/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/zero-element/go-etdereum/mobile")
